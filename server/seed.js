...
.then(() => {
    return Students.bulkCreate([
        { firstName: "Sassy", lastName: "Fran", email: "sassyKitty@gmail.com", gpa: 3.0, campusId: 1 },
        { firstName: "Billy", lastName: "the Kitten", email: "billy@gmail.com", gpa: 3.7, campusId: 2 },
        { firstName: "Tubbs", lastName: "McTubs", email: "tubz@gmail.com", gpa: 0.1, campusId: 3 },
        { firstName: "Chairman", lastName: "Meow", email: "Meow@gmail.com", gpa: 2.4, campusId: 4 },
        { firstName: "Peaches", lastName: "the magnificient", email: "justdessert@gmail.com", gpa: 4.0, campusId: 5 },
        ...
        { firstName: "Mr", lastName: "Meowgi", email: "waxonwaxoff@gmail.com", gpa: 3.5, campusId:6 },
        { firstName: "Guy", lastName: "Furry", email: "meowmix@gmail.com", gpa: 3.2, campusId: 7},
        { firstName: "Lady", lastName: "Meow Meow", email: "vogue@gmail.com", gpa: 3.6, campusId: 1 },
        { firstName: "Senior", lastName: "Don Gato", email: "elSenor@gmail.com", gpa: 3.9, campusId: 2 },
        { firstName: "Madam", lastName: "Fortune", email: "LuckyKitty@gmail.com", gpa: 3.7, campusId: 3 },
        { firstName: "Conductor", lastName: "Whiskers", email: "choochoo@gmail.com", gpa: 3.2, campusId: 4 },
        { firstName: "Bengal", lastName: "Jack", email: "arggggg@gmail.com", gpa: 2.6, campusId: 5 },
        { firstName: "Macchiato", lastName: "Latte", email: "starbuckslover@gmail.com", gpa: 3.4, campusId: 6 },
        { firstName: "Pumkin", lastName: "Pie", email: "punkin@gmail.com", gpa: 3.2, campusId: 7 },
        { firstName: "Sunny", lastName: "Day", email: "herecomesthesun@gmail.com", gpa: 3.4, campusId: 1  },
        { firstName: "Fred", lastName: "Davie", email: "fredDavie@gmail.com", gpa: 3.5, campusId: 2 },
        { firstName: "Callie", lastName: "Tally", email: "Calliu@gmail.com", gpa: 2.4, campusId:3 },
        { firstName: "Tabitha", lastName: "Tigs", email: "tabby@gmail.com", gpa: 2.3, campusId: 4 },
    ])
})
.then(() => {
    db.close()
